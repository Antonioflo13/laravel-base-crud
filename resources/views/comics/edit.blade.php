...
<section class="container my-5">
    <h4 class="mb-5">Modifica fumetto</h4>
    <form action="{{ route('comics.update', $comic->id) }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="mb-3">
            <label for="title" class="form-label">Titolo</label>
            <input type="text" class="form-control" id="title" aria-describedby="emailHelp" placeholder="Inserisci il titolo" name="title" value="{{ $comic->title }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="sale_date" placeholder="Inserisci la data di pubblicazione" name="sale_date" value="{{ $comic->sale_date }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3 d-flex flex-column">
            ...
            <textarea  id="description" cols="30" rows="10" placeholder="Inserisci la descrizione del fumetto" name="description">{{ $comic->description }}</textarea>
        </div>
